    ...
    <div className="relative w-full max-w-2xl">
      ...
      <div className="relative">
        ...
        <input
          ...
          autoFocus={autoFocus}
          className="w-full pl-12 pr-12 py-4 bg-white/5 backdrop-blur-xl border border-white/20 rounded-2xl text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-white/40 transition-all duration-200"
        />
      ...
      {showSuggestions && (
        <Card className="absolute top-full left-0 right-0 mt-2 bg-white/5 backdrop-blur-xl border-white/10 rounded-2xl shadow-2xl z-50 max-h-96 overflow-hidden">
            ...
            {suggestions.length > 0 && (
              <div className="p-4 border-b border-white/10">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-white/60 text-sm font-medium">Suggestions</span>
                </div>
                <div className="space-y-2">
                  {suggestions.map((suggestion, index) => (
                    <button
                      ...
                      className="w-full text-left px-3 py-2 rounded-lg text-white hover:bg-white/10 transition-all duration-200 text-sm"
                    >
              ...
              <div className="p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <Button
                    ...
                    className="text-white/40 hover:text-white/60 text-xs h-6 px-2"
                  >
                    Clear
                  </Button>
                </div>
